 ...
 * @author lyzirving
 */
public class ImgHorizontalGaussianFilter extends BaseFilter {
    private static final String TAG = "ImgHorizontalGaussianFilter";

    private int mTextureWidthOffsetHandler, mTextureHeightOffsetHandler;
    private int mMatrixHandler;
    private float[] mMatrix = new float[16];

    public ImgHorizontalGaussianFilter(Context ctx) {
    ...
    public void setBlurSize(float blurSize) {
        setFloatValue(mTextureWidthOffsetHandler, blurSize / mOutputWidth,
                mTextureHeightOffsetHandler, 0);
    }
}
